...
// import { ICustomDatePicker_i18n } from './CustomDatePicker_i18n';
...
//    * @param onChange will be called every time the date picker change it's value. `this` will be the `CustomDatePicker​​` instance.
//    */
//   constructor(public onChange: () => void = () => void 0, public i18n: ICustomDatePicker_i18n, public format: string) {
//     this.buildContent();
//   }
...
//     parent.append(this.element as HTMLInputElement);
//   }
...
//     this.element = $$('input', { className: 'picker-input' }).el as HTMLInputElement;
